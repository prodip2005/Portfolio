...
const AboutPage = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12 relative z-10 -mt-20 lg:-mt-24">
      {/* Main Card container */}
      <div className="bg-card/90 backdrop-blur-md border border-gray-800 rounded-3xl p-8 md:p-12 mb-8 shadow-2xl w-full lg:w-[calc(100%-320px-2rem)] ml-auto transition-colors duration-300">
        ...
        <div className="mb-10">
          ...
          <div className="space-y-4 text-gray-400 leading-relaxed text-base">
            <p>
              Hey there! I am <span className="font-bold text-foreground">Prodip Hore</span> from
          ...
          <ul className="space-y-6 text-gray-400">
            <li className="flex flex-col">
              ...
              <span className="text-sm mt-1">
                Patuakhali Science and Technology University (PSTU) • 2024 - Present
              </span>
            </li>
            <li className="flex flex-col">
              <span className="text-lg font-bold text-foreground">
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-gray-400">
            <div>
              <h4 className="font-bold text-foreground mb-2 text-lg">Languages</h4>
              <p className="text-sm">
        ...
        <div className="mb-10">
          ...
          <div className="space-y-8 text-gray-400">
            <div className="relative pl-6 border-l-2 border-gray-800">
              ...
              ></div>
              <h3 className="text-lg font-bold text-foreground">Web Developer Intern</h3>
            ...
            <div className="relative pl-6 border-l-2 border-gray-800">
              <div
                ...
                style={{ backgroundColor: 'var(--primary-color)' }}
              ></div>
              <h3 className="text-lg font-bold text-foreground">Freelance Developer</h3>
              <p className="text-xs font-mono mt-1 mb-3 opacity-80">2022 - 2024</p>
              <p className="text-sm leading-relaxed">
        ...
        <div className="mb-10">
          ...
          <div className="space-y-4 text-gray-400">
            <ul className="list-disc pl-5 marker:text-primary space-y-2 text-sm leading-relaxed">
              <li>Mastering advanced Full-Stack Development and Web Security.</li>
              <li>Contributing to meaningful open-source projects and communities.</li>
              <li>Building scalable, accessible, and user-centric web applications.</li>
              <li>Continually learning new technologies and sharing knowledge with others.</li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-10">
          ...
          <div className="space-y-6 text-gray-400 text-sm leading-relaxed">
            <p>
              ...
              to be part of your vision. Whether you need a freelance developer to help bring 
              your ideas to life or a teammate for an open-source initiative, feel free to reach out.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4 pt-4">
              ...
              >
                <Github size={18} />
                <span>GitHub</span>
                <ExternalLink size={14} className="opacity-0 -ml-2 group-hover:opacity-100 group-hover:ml-0 transition-all duration-300" />
              </Link>
...
fs.writeFileSync('src/app/(withCommonLayout)/about/page.jsx', content.replace(/Let's/g, "Let&apos;s"));
