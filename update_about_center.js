...
const AboutPage = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 pb-12 relative z-10 -mt-20 lg:-mt-24">
      {/* Intro Section */}
      <div className="bg-card/90 backdrop-blur-md border border-primary-border/20 rounded-3xl p-8 md:p-12 mb-8 shadow-2xl">
        ...
        <div className="mt-10">
          ...
          <div className="space-y-4 text-foreground/80 text-[15px]">
            <ul className="list-disc pl-5 marker:text-primary space-y-2 opacity-90">
        ...
        <div className="mt-10">
          ...
          <div className="space-y-4 text-foreground/80 text-[15px]">
            ...
            <p className="font-medium mt-4 text-foreground">
